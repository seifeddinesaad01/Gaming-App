...
import manetteicon from "../../assets/img/manetteicon.png";
import val from "../../assets/img/val.jpg";
import participants from "../../assets/img/participants.png";
          ...
          <div className="Detail">
            {tournament && (
              <div>
                ...
                <div className="G">{formatDate(new Date(tournament.date))}</div>
                ...
                <a className="linkparticipate" href={tournament.link}>
              ...
              <div>
                {tournament.jeux === "free fire" ? (
                  <p>
                    ...
                    All teams are required to read the tournament rules and
                    regulations. Participation in the tournament means that the
                    team agrees to abide by all rules and regulations. Any team
                    that violates the rules will be disqualified from the
                    tournament.
                    <br />
                    <br />
                    Punctuality
                    <br />
                    <br />
                    All teams and players must be in the dedicated Discord Room
                    lobby (link on details page) and ready to play no later than
                    5 minutes before the match begins. If the team is not ready,
                    ...
                    <br />
                    <br />
                    Matches will start as per schedule and be shortened unless
                    prior notice is given by eStream of postponement or
                    cancellation. Teams that violate the rules will be penalized
                    and punished.
                    <br />
                    <br />
                    Tournament progress
                    ...
                    <br />
                    ❖ Registration will be done through the eStream portal.
                    <br />
                    ❖ Participants must use a personal account when registering.
                    <br />
                    ❖ Each participant can only be a member of one team in the
                    tournament.
                    <br />
                    ❖ Team names and nicknames in the game should not contain
                    any explicit/vulgar content words.
                    <br />
                    ❖ The team must consist of a minimum of four members and a
                    maximum of six members members.
                    <br />
                    ❖ All matches are in Battle Royale Squad Mode. after
                    registration.
                    <br />
                    ❖ Registered team members cannot be changed/replaced.
                    <br />
                    Teams are only allowed to play with registered players
                    difference Found using multiple accounts will be
                    disqualified.
                    <br />
                    ❖ It is not recommended to use VPN and other supporting
                    network connection applications.
                    <br />
                    ❖ Players are responsible for their internet connection and
                    eStream Premier Series org will not be responsible for any
                    ...
                    <br />
                    <br />
                    Tournament format is agreed upon in a Descord room in
                    Description.
                  </p>
                ) : tournament.jeux === "fortnite" ? (
                  <div>Content to render if tournament.jeux is 'fortnite'</div>
            ...
            <div className="details-p">
              ...
              <div className="participants-p">
                <img
                  src={`${participants}`}
                  alt="participants"
                  className="particon-p"
                />
                {tournament.nbparticipants} participants
              </div>
              <div className="date-p">
                <img
                  src={`${calendar}`}
                  alt="calender"
                  className="calendar-p"
                />
                {/* {tournament.date} */}
